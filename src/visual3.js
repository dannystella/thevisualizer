...
// export default class VisualThree extends React.Component {
//     constructor(props) {
//         super(props);
//         this.createVisualizationThree = this.createVisualizationThree.bind(this);
//     }
//     componentDidMount() {
//         this.createVisualizationThree();
//     }

//     createVisualizationThree(){
...
//             ctx.beginPath();
//             ctx.moveTo( 0, Math.round( canvas.height ) );
...
//             };
//             ctx.lineTo( canvas.width, Math.round( canvas.height ) );
